...
#ifdef DBC
        { return DBC_CONTRACT(f_m, (x))().call(*this, &derived1::DBC_BODY(f_m),
        x, "f_m"); }
protected:
    class DBC_CONTRACT(f_m, (x)): public dbc::fun<int, const int&>::
            mem<const derived1, base<int>::DBC_CONTRACT(f_m, (x))> {
...
public:
    ...
    virtual int f(const int& x) const
#ifdef DBC
        { return DBC_CONTRACT(f, (x))().call(*this, &derived2::DBC_BODY(f), x,
        "f"); }
protected:
    class DBC_CONTRACT(f, (x)): public dbc::fun<int, const int&>::
            mem<const derived2, derived1::DBC_CONTRACT(f, (x))> {
