...
#include <string>
        ...
        #define BOOST_CONTRACT_TEST_LIB_X_DECL BOOST_SYMBOL_EXPORT
    #else
        #define BOOST_CONTRACT_TEST_LIB_X_DECL BOOST_SYMBOL_IMPORT
    #endif
#else
    #define BOOST_CONTRACT_TEST_LIB_X_DECL /* nothing */
#endif

BOOST_CONTRACT_TEST_AUX_OTESTSTREAM_STR_DECL(
        BOOST_CONTRACT_TEST_LIB_X_DECL, out)

void BOOST_CONTRACT_TEST_LIB_X_DECL x();
