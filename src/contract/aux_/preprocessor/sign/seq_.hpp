...
#define CONTRACT_AUX_PP_SIGN_SEQ_FUNCTION_TEMPLATE_ARGS_INDEX   4
#define CONTRACT_AUX_PP_SIGN_SEQ_STATIC_INDEX                   5
#define CONTRACT_AUX_PP_SIGN_SEQ_VIRTUAL_INDEX                  6
#define CONTRACT_AUX_PP_SIGN_SEQ_RESULT_TYPE_INDEX              7
#define CONTRACT_AUX_PP_SIGN_SEQ_FUNCTION_NAME_INDEX            8
#define CONTRACT_AUX_PP_SIGN_SEQ_ARGS_INDEX                     9
#define CONTRACT_AUX_PP_SIGN_SEQ_CONST_INDEX                    10

#define CONTRACT_AUX_PP_SIGN_SEQ_SIZE_NO_CONTRACT               11

#define CONTRACT_AUX_PP_SIGN_SEQ_PRECONDITION_INDEX             11
#define CONTRACT_AUX_PP_SIGN_SEQ_POSTCONDITION_RESULT_INDEX     12
#define CONTRACT_AUX_PP_SIGN_SEQ_POSTCONDITION_INDEX            13
#define CONTRACT_AUX_PP_SIGN_SEQ_BODY_INDEX                     14

#define CONTRACT_AUX_PP_SIGN_SEQ_SIZE_WITH_CONTRACT             15
