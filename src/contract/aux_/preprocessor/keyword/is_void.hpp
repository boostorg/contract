...
#ifndef CONTRACT_AUX_PP_KEYWORD_IS_VOID_HPP_
...
#define CONTRACT_AUX_PP_KEYWORD_VOID_void (1)

#define CONTRACT_AUX_PP_KEYWORD_IS_VOID(token) \
    CONTRACT_AUX_PP_KEYWORD_CHECK( \
            CONTRACT_AUX_PP_KEYWORD_VOID_, token)
