...
// Class types.
// ClassType := C [+ const ] [+ copyable] (C is untagged class type).
    
#define CONTRACT_typedef_maybeconst_class_type \
    typedef typename aux::remove_copyable<ClassType>::type \
            maybeconst_class_type;

#define CONTRACT_typedef_class_type \
    typedef typename boost::remove_const<maybeconst_class_type>::type \
            class_type;

#define CONTRACT_typedef_maybeconst_class_ptr \
    typedef typename boost::add_pointer<maybeconst_class_type \
            >::type maybeconst_class_ptr;

#define CONTRACT_typedef_arg_class_ptr \
    typedef typename aux::arg<maybeconst_class_ptr>::type \
            arg_class_ptr;
...
#define CONTRACT_typedef_body_member_function_ptr_(unused) \
    /* Use two support types for compiler compatibility (MSVC). */ \
    ...
    typedef typename boost::mpl::if_< \
                boost::is_const<maybeconst_class_type> \
...
#define CONTRACT_typedef_precondition_function_ptr \
    typedef void ( \
            ...
            * precondition_function_ptr)( \
            ...
            BOOST_PP_EXPR_IF(CONTRACT_is_member, const) ;
