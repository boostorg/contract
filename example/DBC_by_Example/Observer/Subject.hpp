...
public:
    ...
    /** Construct subject. */
    Subject(void)
    DBC_CONSTRUCTOR( (public) (Subject)( (void) ), {
    }, {
    }, {})

    virtual ~Subject(void)
    DBC_DESTRUCTOR( (public) (virtual) (Subject)( (void) ), {})
    ...
    DBC_MEM_FUN( (public) (void) DBC_COPYABLE(Subject)
        ...
        std::remove(os.begin(), os.end(), o.now);
...
protected:
    ...
    void notify(void)
    DBC_MEM_FUN( (protected) (void) (Subject) (notify)( (void) ), {
    }, {
        const std::list<const Observer*>& os = self.now.observers();
    ...
    const std::list<const Observer*> observers(void) const
