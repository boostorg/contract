...
public:
    ...
    DBC_DESTRUCTOR( (public) (Courier)( (void) ), {})

    // Queries //

    /** Return insurance cover. */
    double insuranceCoverDollar(void) const
    DBC_MEM_FUN( (public) (double) (Courier)
            (insuranceCoverDollar)( (void) ) (const), {
    }, {
    }, ;)
...
class DifferentCourier: public Courier
        DBC_MULTI_INHERIT_OBJECT(DifferentCourier) {
public:
    // Creation //
    ...
    /** Destroy this object. */
    virtual ~DifferentCourier(void)
    DBC_DESTRUCTOR( (public) (DifferentCourier)( (void) ), {})
