...
public:
    CustomerManager(void): customers_()
    DBC_CONSTRUCTOR( (public) (CustomerManager)( (void) ), {
    }, {
    }, {})

    virtual ~CustomerManager(void)
    DBC_DESTRUCTOR( (public) (virtual) (CustomerManager)( (void) ), {})

    // Basic Queries //

    /** Return number of customers. */
    int count(void) const
    DBC_MEM_FUN( (public) (int) (CustomerManager) (count)( (void) ) (const), {
    }, {
    }, ;)
