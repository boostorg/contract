...
public:
    ...
    DBC_DESTRUCTOR( (public) (virtual) (template)(SimpleQueue)( (void) ), {})
    ...
    DBC_MEM_FUN( (public) (int) (template)(SimpleQueue)
            (capacity)( (void) ) (const), {
    }, {
    }, { 
    ...
    DBC_MEM_FUN( (public) (const T&) (template)(SimpleQueue)
            (head)( (void) ) (const), {
    ...
    DBC_MEM_FUN( (public) (bool) (template)(SimpleQueue)
            (isEmpty)( (void) ) (const), {
    }, {
