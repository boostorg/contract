...
public:
    ...
    int capacity() const
    DBC_MEM_FUN( (public) (int) (template)(Stack4) (capacity)() (const), {
    }, {
    }, ; )

    /** Number of stack elements. */
    int count() const
    DBC_MEM_FUN( (public) (int) (template)(Stack4) (count)() (const), {
    }, {
    }, ; )

    /** Top element. */
    const T& item() const
    DBC_MEM_FUN( (public) (const T&) (template)(Stack4) (item)() (const), {
    ...
    /** If stack is empty. */
    bool empty() const 
    DBC_MEM_FUN( (public) (bool) (template)(Stack4) (empty)() (const), {
    }, {
    ...
    /** If stack is full. */
    bool full() const
    DBC_MEM_FUN( (public) (bool) (template)(Stack4) (full)() (const), {
    }, {
...
private:
    ...
    DBC_INVARIANT(Stack4, {
        ...
        DBC_ASSERT_STREAM(self.count() <= self.capacity(), 
                "count no greather than capacity",
