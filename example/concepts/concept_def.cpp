...
CONTRACT_CONCEPT(
    ...
    (
        explicit constructor_body(T, T) ( intmax_t),
        explicit constructor_body(T, T) ( uintmax_t ),
        explicit constructor_body(T, T) ( long double ),
...
CONTRACT_CONCEPT(
    ...
    (
        constructor_body(T, T) ( int a, float b ),
        destructor_body(T, ~T) ( void ),
        void member_body(T, f) ( void ) const
    )
)
