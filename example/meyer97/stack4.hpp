...
template< typename T >
stack4<T>& CONTRACT_MEMBER_BODY(stack4<T>, operator(=)(assign)) (
        const stack4& right )
{
...
template< typename T >
int CONTRACT_MEMBER_BODY(stack4<T>, capacity) ( void ) const
{
    return capacity_;
}

template< typename T >
int CONTRACT_MEMBER_BODY(stack4<T>, count) ( void ) const
{
    return count_;
}

template< typename T >
const T& CONTRACT_MEMBER_BODY(stack4<T>, item) ( void ) const
{
    return representation_[count() - 1];
}

template< typename T >
bool CONTRACT_MEMBER_BODY(stack4<T>, empty) ( void ) const
{
    return count() == 0;
}

template< typename T >
bool CONTRACT_MEMBER_BODY(stack4<T>, full) ( void ) const
{
    return count() == capacity();
}

template< typename T >
void CONTRACT_MEMBER_BODY(stack4<T>, put) ( const T& x )
{
    representation_[count_++] = x;
}

template< typename T >
void CONTRACT_MEMBER_BODY(stack4<T>, remove) ( void )
{
    --count_;
}
