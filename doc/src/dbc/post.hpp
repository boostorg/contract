 ...
 *
 *  <small>
 *  @note The specified type @c T cannot be abstract (i.e., with one or more
 *      pure virtual functions) because abstract types cannot be instantiated
 *      and therefore they cannot be copied.
 *
 *  </small>
 */
