 ...
 * @endcode
 * 
 * @remark This macro is mainly used for convenience to avoid repeating
...
public:
     ...
     * @param[in] the_condition New condition boolean value.
     *  The condition expression is evaluate to @c true or @c false when this
     *  argument is passed.
     */
     ...
     * @param[in] the_label New assertion label.
     */
     ...
     * @param[in] the_code Text of asserting code.
     */
...
public:
     ...
     */
    explicit uraise(const E& exception);
};
