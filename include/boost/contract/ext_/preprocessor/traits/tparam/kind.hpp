...
#define BOOST_CONTRACT_EXT_PP_TPARAM_TRAITS_KIND_SIGN_(sign, traits) \
    BOOST_PP_IIF(BOOST_CONTRACT_EXT_PP_KEYWORD_IS_TYPENAME(sign), \
        BOOST_CONTRACT_EXT_PP_KEYWORD_TYPENAME_REM \
    , BOOST_PP_IIF(BOOST_CONTRACT_EXT_PP_KEYWORD_IS_CLASS(sign), \
        BOOST_CONTRACT_EXT_PP_KEYWORD_CLASS_REM \
