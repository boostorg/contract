...
// Expand to const-assertion-traits or bool-assertion-traits
// (depending on ASSERTION_TRAITS_KIND) to be inspected using
// CONST_ASSERTION_TRAITS and BOOL_ASSERTION_TRAITS respectively.
