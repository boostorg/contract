...
#   define BOOST_CONTRACT_EXT_PP_TRAITS_FUNC_TRAILING_RETURN_(sign_traits) \
        sign_traits
#else
#   define BOOST_CONTRACT_EXT_PP_TRAITS_FUNC_TRAILING_RETURN_(sign_traits) \
        BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_TRAILING_RETURN_PARSE(sign_traits)
#endif
...
#define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS(sign) \
    ...
    BOOST_CONTRACT_EXT_PP_TRAITS_FUNC_TRAILING_RETURN_( \
