...
// NOTE: Unfortunately, these internal macro names repeat "FUNC" twice but that
// is to avoid name clashes with other internal macros defined by traits/func/.
...
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_NAME_(sign_traits) \
        sign_traits
#else
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_NAME_(sign_traits) \
...
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_RETURN_(sign_traits) \
        sign_traits
#else
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_RETURN_(sign_traits) \
...
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_CLASSIFIERS_(sign_traits) \
        sign_traits
#else
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_CLASSIFIERS_(sign_traits) \
...
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_TEMPLATE_(sign_traits) \
        sign_traits
#else
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_TEMPLATE_(sign_traits) \
...
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_EXPORT_(sign_traits) \
        sign_traits
#else
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_EXPORT_(sign_traits) \
...
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_VERBATIM_(sign_traits) \
        sign_traits
#else
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_VERBATIM_(sign_traits) \
...
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUCN_ACCESS_(sign_traits) \
        sign_traits
#else
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_ACCESS_(sign_traits) \
...
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_DONE_(sign_traits) \
        sign_traits
#else
#   define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_DONE_ \
...
#define BOOST_CONTRACT_EXT_PP_FUNC_TRAITS(sign) \
    BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_DONE_( \
    BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_NAME_( \
    BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_RETURN_( \
    BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_CLASSIFIERS_( \
    BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_TEMPLATE_( \
    BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_EXPORT_( \
    BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_VERBATIM_( \
    BOOST_CONTRACT_EXT_PP_FUNC_TRAITS_FUNC_ACCESS_( \
