...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_UNSIGNED_IS_unsigned (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_UNSIGNED_REM_unsigned

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_UNSIGNED(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_UNSIGNED_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_UNSIGNED_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_UNSIGNED_REM_)
