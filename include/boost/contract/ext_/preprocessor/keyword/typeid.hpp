...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEID_IS_typeid (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEID_REM_typeid

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_TYPEID(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEID_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEID_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEID_REM_)
