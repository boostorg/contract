...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CHAR16_T_IS_char16_t (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CHAR16_T_REM_char16_t

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_CHAR16_T(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CHAR16_T_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_CHAR16_T_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CHAR16_T_REM_)
