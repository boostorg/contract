...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DOUBLE_IS_double (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DOUBLE_REM_double

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_DOUBLE(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DOUBLE_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_DOUBLE_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DOUBLE_REM_)
