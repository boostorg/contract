...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_WHILE_IS_while (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_WHILE_REM_while

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_WHILE(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_WHILE_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_WHILE_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_WHILE_REM_)
