...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TRY_IS_try (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TRY_REM_try

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_TRY(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TRY_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_TRY_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TRY_REM_)
