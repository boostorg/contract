...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_MUTABLE_IS_mutable (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_MUTABLE_REM_mutable

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_MUTABLE(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_MUTABLE_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_MUTABLE_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_MUTABLE_REM_)
