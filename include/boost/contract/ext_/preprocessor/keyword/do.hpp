...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DO_IS_do (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DO_REM_do

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_DO(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DO_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_DO_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DO_REM_)
