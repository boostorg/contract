...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TRUE_IS_true (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TRUE_REM_true

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_TRUE(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TRUE_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_TRUE_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TRUE_REM_)
