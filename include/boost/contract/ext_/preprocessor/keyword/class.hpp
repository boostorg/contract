...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CLASS_IS_class (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CLASS_REM_class

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_CLASS(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CLASS_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_CLASS_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CLASS_REM_)
