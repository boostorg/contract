...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_RETURN_IS_return (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_RETURN_REM_return

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_RETURN(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_RETURN_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_RETURN_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_RETURN_REM_)
