...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_SWITCH_IS_switch (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_SWITCH_REM_switch

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_SWITCH(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_SWITCH_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_SWITCH_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_SWITCH_REM_)
