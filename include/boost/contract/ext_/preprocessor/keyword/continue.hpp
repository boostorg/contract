...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONTINUE_IS_continue (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONTINUE_REM_continue

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_CONTINUE(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CONTINUE_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONTINUE_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CONTINUE_REM_)
