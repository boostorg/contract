...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_IS_const (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_REM_const

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_CONST(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_REM_)
