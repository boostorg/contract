...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_AND_EQ_IS_and_eq (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_AND_EQ_REM_and_eq

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_AND_EQ(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_AND_EQ_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_AND_EQ_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_AND_EQ_REM_)
