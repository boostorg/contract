...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_XOR_IS_xor (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_XOR_REM_xor

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_XOR(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_XOR_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_XOR_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_XOR_REM_)
