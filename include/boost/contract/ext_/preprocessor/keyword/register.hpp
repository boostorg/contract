...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_REGISTER_IS_register (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_REGISTER_REM_register

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_REGISTER(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_REGISTER_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_REGISTER_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_REGISTER_REM_)
