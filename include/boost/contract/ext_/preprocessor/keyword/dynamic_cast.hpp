...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DYNAMIC_CAST_IS_dynamic_cast (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DYNAMIC_CAST_REM_dynamic_cast

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_DYNAMIC_CAST(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DYNAMIC_CAST_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_DYNAMIC_CAST_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DYNAMIC_CAST_REM_)
