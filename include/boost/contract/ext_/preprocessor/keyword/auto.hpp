...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_AUTO_IS_auto (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_AUTO_REM_auto

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_AUTO(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_AUTO_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_AUTO_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_AUTO_REM_)
