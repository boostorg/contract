...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_ASSERT_IS_static_assert (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_ASSERT_REM_static_assert

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_STATIC_ASSERT(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_ASSERT_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_ASSERT_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_ASSERT_REM_)
