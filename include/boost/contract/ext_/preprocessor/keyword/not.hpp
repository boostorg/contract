...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_IS_not (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_REM_not

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_NOT(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_REM_)
