...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONSTEXPR_IS_constexpr (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONSTEXPR_REM_constexpr

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_CONSTEXPR(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CONSTEXPR_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONSTEXPR_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CONSTEXPR_REM_)
