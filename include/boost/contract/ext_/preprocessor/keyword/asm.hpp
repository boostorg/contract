...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_ASM_IS_asm (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_ASM_REM_asm

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_ASM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_ASM_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_ASM_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_ASM_REM_)
