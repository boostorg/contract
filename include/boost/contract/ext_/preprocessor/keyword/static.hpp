...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_IS_static (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_REM_static

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_STATIC(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_STATIC_REM_)
