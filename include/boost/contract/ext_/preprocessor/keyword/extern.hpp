...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_EXTERN_IS_extern (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_EXTERN_REM_extern

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_EXTERN(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_EXTERN_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_EXTERN_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_EXTERN_REM_)
