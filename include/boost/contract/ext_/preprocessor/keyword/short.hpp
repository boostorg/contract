...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_SHORT_IS_short (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_SHORT_REM_short

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_SHORT(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_SHORT_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_SHORT_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_SHORT_REM_)
