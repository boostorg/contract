...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_OR_IS_or (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_OR_REM_or

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_OR(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_OR_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_OR_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_OR_REM_)
