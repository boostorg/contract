...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_WCHAR_T_IS_wchar_t (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_WCHAR_T_REM_wchar_t

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_WCHAR_T(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_WCHAR_T_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_WCHAR_T_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_WCHAR_T_REM_)
