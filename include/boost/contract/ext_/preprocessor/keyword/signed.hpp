...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_SIGNED_IS_signed (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_SIGNED_REM_signed

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_SIGNED(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_SIGNED_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_SIGNED_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_SIGNED_REM_)
