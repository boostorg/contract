...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_EXTENDS_IS_extends (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_EXTENDS_REM_extends

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_EXTENDS(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_EXTENDS_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_EXTENDS_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_EXTENDS_REM_)
