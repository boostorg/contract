...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_POSTCONDITION_IS_postcondition (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_POSTCONDITION_REM_postcondition

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_POSTCONDITION(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_POSTCONDITION_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_POSTCONDITION_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_POSTCONDITION_REM_)
