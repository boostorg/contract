...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_BITOR_IS_bitor (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_BITOR_REM_bitor

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_BITOR(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_BITOR_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_BITOR_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_BITOR_REM_)
