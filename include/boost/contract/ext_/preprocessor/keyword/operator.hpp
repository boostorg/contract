...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_OPERATOR_IS_operator (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_OPERATOR_REM_operator

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_OPERATOR(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_OPERATOR_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_OPERATOR_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_OPERATOR_REM_)
