...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_ALIGNOF_IS_alignof (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_ALIGNOF_REM_alignof

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_ALIGNOF(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_ALIGNOF_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_ALIGNOF_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_ALIGNOF_REM_)
