...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TEMPLATE_IS_template (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TEMPLATE_REM_template

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_TEMPLATE(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TEMPLATE_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_TEMPLATE_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TEMPLATE_REM_)
