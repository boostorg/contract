...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CASE_IS_case (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CASE_REM_case

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_CASE(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CASE_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_CASE_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CASE_REM_)
