...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NULLPTR_IS_nullptr (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NULLPTR_REM_nullptr

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_NULLPTR(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NULLPTR_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_NULLPTR_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NULLPTR_REM_)
