...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEDEF_IS_typedef (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEDEF_REM_typedef

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_TYPEDEF(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEDEF_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEDEF_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TYPEDEF_REM_)
