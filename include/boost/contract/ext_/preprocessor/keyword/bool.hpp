...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_BOOL_IS_bool (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_BOOL_REM_bool

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_BOOL(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_BOOL_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_BOOL_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_BOOL_REM_)
