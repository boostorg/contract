...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_FOR_IS_for (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_FOR_REM_for

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_FOR(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_FOR_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_FOR_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_FOR_REM_)
