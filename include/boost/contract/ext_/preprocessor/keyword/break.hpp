...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_BREAK_IS_break (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_BREAK_REM_break

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_BREAK(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_BREAK_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_BREAK_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_BREAK_REM_)
