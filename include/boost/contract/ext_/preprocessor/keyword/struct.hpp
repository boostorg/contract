...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_STRUCT_IS_struct (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_STRUCT_REM_struct

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_STRUCT(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_STRUCT_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_STRUCT_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_STRUCT_REM_)
