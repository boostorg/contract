...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NAMESPACE_IS_namespace (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NAMESPACE_REM_namespace

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_NAMESPACE(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NAMESPACE_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_NAMESPACE_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NAMESPACE_REM_)
