...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DEFAULT_IS_default (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DEFAULT_REM_default

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_DEFAULT(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DEFAULT_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_DEFAULT_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DEFAULT_REM_)
