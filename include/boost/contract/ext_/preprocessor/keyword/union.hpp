...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_UNION_IS_union (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_UNION_REM_union

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_UNION(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_UNION_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_UNION_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_UNION_REM_)
