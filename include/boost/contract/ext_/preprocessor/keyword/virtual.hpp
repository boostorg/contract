...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_VIRTUAL_IS_virtual (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_VIRTUAL_REM_virtual

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_VIRTUAL(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_VIRTUAL_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_VIRTUAL_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_VIRTUAL_REM_)
