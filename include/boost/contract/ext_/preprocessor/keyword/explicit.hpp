...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_EXPLICIT_IS_explicit (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_EXPLICIT_REM_explicit

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_EXPLICIT(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_EXPLICIT_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_EXPLICIT_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_EXPLICIT_REM_)
