...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_EQ_IS_not_eq (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_EQ_REM_not_eq

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_NOT_EQ(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_EQ_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_EQ_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NOT_EQ_REM_)
