...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_CAST_IS_const_cast (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_CAST_REM_const_cast

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_CONST_CAST(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_CAST_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_CAST_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_CONST_CAST_REM_)
