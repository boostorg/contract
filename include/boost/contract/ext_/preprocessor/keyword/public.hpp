...
#ifndef BOOST_CONTRACT_EXT_PP_KEYWORD_PUBLIC_HPP_
...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_PUBLIC_IS_public (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_PUBLIC_REM_public

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_PUBLIC(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_PUBLIC_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_PUBLIC_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_PUBLIC_REM_)
