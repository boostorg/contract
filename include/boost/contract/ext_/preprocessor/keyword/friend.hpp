...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_FRIEND_IS_friend (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_FRIEND_REM_friend

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_FRIEND(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_FRIEND_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_FRIEND_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_FRIEND_REM_)
