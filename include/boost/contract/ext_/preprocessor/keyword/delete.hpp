...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DELETE_IS_delete (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_DELETE_REM_delete

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_DELETE(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DELETE_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_DELETE_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_DELETE_REM_)
