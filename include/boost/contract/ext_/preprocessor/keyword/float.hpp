...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_FLOAT_IS_float (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_FLOAT_REM_float

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_FLOAT(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_FLOAT_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_FLOAT_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_FLOAT_REM_)
