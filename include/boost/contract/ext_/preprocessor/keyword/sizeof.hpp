...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_SIZEOF_IS_sizeof (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_SIZEOF_REM_sizeof

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_SIZEOF(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_SIZEOF_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_SIZEOF_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_SIZEOF_REM_)
