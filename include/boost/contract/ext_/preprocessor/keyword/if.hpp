...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_IF_IS_if (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_IF_REM_if

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_IF(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_IF_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IF_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_IF_REM_)
