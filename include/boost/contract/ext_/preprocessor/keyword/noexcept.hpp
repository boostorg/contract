...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NOEXCEPT_IS_noexcept (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_NOEXCEPT_REM_noexcept

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_NOEXCEPT(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NOEXCEPT_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_NOEXCEPT_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_NOEXCEPT_REM_)
