...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TYPENAME_IS_typename (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_TYPENAME_REM_typename

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_TYPENAME(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TYPENAME_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_TYPENAME_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_TYPENAME_REM_)
