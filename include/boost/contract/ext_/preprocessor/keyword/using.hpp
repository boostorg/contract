...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_USING_IS_using (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_USING_REM_using

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_USING(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_USING_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_USING_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_USING_REM_)
