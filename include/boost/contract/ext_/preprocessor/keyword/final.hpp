...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_FINAL_IS_final (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_FINAL_REM_final

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_FINAL(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_FINAL_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_FINAL_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_FINAL_REM_)
