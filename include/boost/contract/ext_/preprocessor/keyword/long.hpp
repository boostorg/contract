...
#define BOOST_CONTRACT_EXT_PP_KEYWORD_LONG_IS_long (1)
// The following macro must expand to nothing.
#define BOOST_CONTRACT_EXT_PP_KEYWORD_LONG_REM_long

// PUBLIC //

#define BOOST_CONTRACT_EXT_PP_KEYWORD_IS_LONG(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_IS(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_LONG_IS_)

#define BOOST_CONTRACT_EXT_PP_KEYWORD_LONG_REM(tokens) \
    BOOST_CONTRACT_EXT_PP_KEYWORD_UTILITY_REM(tokens, \
            BOOST_CONTRACT_EXT_PP_KEYWORD_LONG_REM_)
