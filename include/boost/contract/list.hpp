...
#ifndef BOOST_CONTRACT_LIST_HPP_
#define BOOST_CONTRACT_LIST_HPP_
...
#define BOOST_CONTRACT_BASES BOOST_CONTRACT_AUX_NAME1(bases)

#define BOOST_CONTRACT_LIST(...) \
    boost::mpl::vector< \
        BOOST_PP_SEQ_FOR_EACH_I(BOOST_CONTRACT_LIST_, ~, \
                BOOST_PP_VARIADIC_TO_SEQ(__VA_ARGS__)) \
    >

/* PRIVATE */

#define BOOST_CONTRACT_LIST_(r, unused, i, base) \
    BOOST_PP_COMMA_IF(i) \
    BOOST_CONTRACT_LIST_REMOVE_( \
...
#define BOOST_CONTRACT_LIST_REMOVE_(is_macro, remove_macro, tokens) \
