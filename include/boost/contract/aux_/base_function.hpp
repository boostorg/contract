...
template< class FuncTraits, typename FuncPtr, class Class, typename Arg0 >
class base_function {
    typedef boost::contract::aux::function<FuncTraits, FuncPtr, Class, Arg0>
...
public:
    ...
    template< class Base >
    void operator() ( Base* ) {
        call<Base>(boost::mpl::bool_<FuncTraits::template has_member_function<
...
private:
    ...
    void call ( boost::mpl::true_ const& has_func ) {
        ...
        base_virtual_func_ptr base_virtual_func = FuncTraits::template
...
struct base_function<boost::contract::aux::none, boost::contract::aux::none,
        Class, Arg0> {
    void derived_function (
        boost::contract::aux::function<boost::contract::aux::none,
                boost::contract::aux::none, Class, Arg0>*
    ) {}
